...
const recipesData = [
    ...
    },
    {
        ...
        temperature: "Cold",
        difficulty: "Medium",
        important_notes: "Must use Cold Foam Pitcher, not Portable Cold Foamer", 
        full_recipe: "Pump Classic syrup (full dose pump) 2/3/4. Add cold milk to the top line on cup. Pour cup contents into Cold Foam Pitcher. Add level scoops of Matcha powder 2/3/4. Add ice. Blend - Press button #3, Press button #4. Pour contents into cup.",
        seasonal: false,
        popular: true,
        prep_time: "2 minutes",
    ...
    {
        id: 87,
        drink_name: "Tall Hot White Chocolate Mocha",
        size: "Tall",
        abbreviation: "WM",
        shots: "1",
        syrup_pumps: "3",
        syrup_type: "white chocolate",
        milk_type: "2%",
        milk_line: "second line", // From official cards pattern
        aeration_time: "1-3 seconds",
        special_ingredients: "",
        toppings: "whip",
        preparation_method: "steam",
        category: "Mocha",
        temperature: "Hot",
        difficulty: "Medium",
        important_notes: "Always topped with whip",
        full_recipe: "2% to second line on pitcher, aerate 1-3 seconds, 3 pumps white chocolate mocha sauce, 1 shot, swirl espresso and sauce, fill cup with steamed milk to ¼ inch below rim, top with whipped cream."
    },
    {
        id: 88,
        drink_name: "Venti Hot White Chocolate Mocha", 
        size: "Venti",
        abbreviation: "WM",
        shots: "2",
        syrup_pumps: "5",
        ...
        difficulty: "Medium",
        important_notes: "Always topped with whip",
        full_recipe: "2% to top line on pitcher, aerate 1-3 seconds, 5 pumps white chocolate mocha sauce, 2 shots, swirl espresso and sauce, fill cup with steamed milk to ¼ inch below rim, top with whipped cream."
    },
    {
        id: 89,
        drink_name: "Tall Hot Mocha",
        size: "Tall", 
        abbreviation: "M",
        shots: "1",
        syrup_pumps: "3",
        ...
        difficulty: "Medium",
        important_notes: "Always topped with whip",
        full_recipe: "2% to second line on pitcher, aerate 1-3 seconds, 3 pumps mocha sauce, 1 shot, swirl espresso and sauce, fill cup with steamed milk to ¼ inch below rim, top with whipped cream."
    },
    {
        id: 90,
        drink_name: "Tall Cappuccino",
        size: "Tall",
        abbreviation: "C", 
        shots: "1",
        syrup_pumps: "",
        syrup_type: "",
        milk_type: "2%",
        milk_line: "below appropriate line",
        aeration_time: "6-8 seconds",
        special_ingredients: "",
        toppings: "",
        preparation_method: "steam",
        ...
        temperature: "Hot",
        difficulty: "Hard",
        important_notes: "MUST FREE POUR MILK, 50/50 milk to foam ratio",
        full_recipe: "Pour milk to below appropriate line on pitcher, aerate 6-8 seconds, 1 shot, free pour foamy milk into cup ¼ inch below cup rim."
    },
    {
        id: 91,
        drink_name: "Tall Flat White",
        size: "Tall",
        abbreviation: "FW",
        shots: "2",
        syrup_pumps: "",
        ...
        temperature: "Hot", 
        difficulty: "Expert",
        important_notes: "Uses RISTRETTO shots, whole milk, signature dot",
        full_recipe: "Pour whole milk to appropriate line on pitcher, aerate 1-3 seconds, 2 ristretto shots, free pour milk creating signature dot."
    },
    {
        id: 92,
        drink_name: "Venti Hot Chocolate", 
        size: "Venti",
        abbreviation: "HC",
        shots: "",
        syrup_pumps: "5",
        ...
        milk_line: "top line",
        aeration_time: "1-3 seconds",
        special_ingredients: "2 pumps vanilla", // VENTI GETS 2 VANILLA
        toppings: "whip, mocha drizzle",
        preparation_method: "steam",
        category: "Other",
        temperature: "Hot",
        difficulty: "Easy",
        important_notes: "Venti gets 2 pumps vanilla unlike other sizes",
        full_recipe: "Pour 2% to top line on pitcher, aerate 1-3 seconds, 5 pumps mocha and TWO pumps vanilla, pour milk, top with whip and mocha drizzle."
    },   
    {
        id: 93,
        drink_name: "Venti Hot Mocha",
        size: "Venti",
        abbreviation: "M",
        shots: "2",
        syrup_pumps: "5",
        ...
        difficulty: "Medium",
        important_notes: "Always topped with whip",
        full_recipe: "2% to top line on pitcher, aerate 1-3 seconds, 5 pumps mocha sauce, 2 shots, swirl espresso and sauce, fill cup with steamed milk to ¼ inch below rim, top with whipped cream.",
        seasonal: false,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Chocolate sauce before shots"
    },
    {
        ...
        difficulty: "Hard",
        important_notes: "MUST FREE POUR MILK, 50/50 milk to foam ratio",
        full_recipe: "Pour milk to below appropriate line on pitcher, aerate 6-8 seconds, 2 shots, free pour foamy milk into cup ¼ inch below cup rim.",
        seasonal: false,
        popular: true,
        prep_time: "3-4 minutes",
        tips: "Practice free pouring"
    ...
    {
        id: 95,
        drink_name: "Iced Lavender Cream Oatmilk Matcha",
        size: "All Sizes",
        abbreviation: "LCML",
        shots: "",
        syrup_pumps: "2/3/4",
        ...
        milk_line: "top line",
        aeration_time: "",
        special_ingredients: "2/3/4 scoops matcha, lavender cream cold foam",
        toppings: "lavender cream cold foam",
        preparation_method: "blend",
        category: "Tea Latte",
        temperature: "Cold",
        difficulty: "Expert",
        important_notes: "Must use Cold Foam Pitcher, not Portable Cold Foamer",
        full_recipe: "Blend Lavender Cream Cold Foam: Pour Vanilla Sweet Cream to 100ml line, Add 2 level scoops of Lavender powder, Blend - press button #3. Pump Classic syrup (full dose pump) 2/3/4, Add Oatmilk to the top line on the cup. Pour cup contents into Cold Foam Pitcher. Add level scoops of Matcha powder 2/3/4. Add ice. Blend - Press button #3, Press button #4. Pour contents to 1 inch (2 cm) below cup rim. Top with lavender Cream Cold Foam. Lid: Nitro/Cold Foam Lid",
        seasonal: true,
        popular: true,
        prep_time: "3-4 minutes",
        tips: "Do not use Portable Cold Foamer as it cannot handle the volume"
    },
    {
        id: 96,
        drink_name: "Iced Cherry Chai",
        size: "All Sizes", 
        abbreviation: "CHCH",
        shots: "",
        syrup_pumps: "3/4/6",
        syrup_type: "chai concentrate",
        milk_type: "cold milk",
        milk_line: "upper line",
        aeration_time: "",
        special_ingredients: "cherry cream cold foam, cherry crunch topping",
        toppings: "cherry cream cold foam, cherry crunch",
        preparation_method: "build",
        category: "Tea Latte",
        temperature: "Cold", 
        difficulty: "Medium",
        important_notes: "Water is not added to Iced Chai Lattes",
        full_recipe: "Blend Cherry Cream Cold Foam: Pour Vanilla Sweet Cream to 100ml line, Add 2 level scoops of Cherry powder, Blend - press button #3. Pump Chai concentrate 3/4/6. Add cold milk to upper line on cup. Fill cup with ice to 1 inch (2 cm) below cup rim. Top with Cherry Cream Cold Foam. Finish with Cherry Crunch topping. Lid: Nitro/Cold Foam lid.",
        seasonal: true,
        popular: true,
        prep_time: "2-3 minutes", 
        tips: "No water added unlike hot chai lattes"
    },
    {
        id: 97,
        drink_name: "Pistachio Frappuccino",
        size: "All Sizes",
        abbreviation: "PITF/PITCF", 
        shots: "",
        syrup_pumps: "2/3/4",
        syrup_type: "pistachio sauce",
        milk_type: "Whole",
        milk_line: "lower line",
        aeration_time: "",
        special_ingredients: "2/3/4 pumps frap roast (skip for crème), salted brown butter topping",
        toppings: "whipped cream, salted brown butter topping",
        preparation_method: "blend",
        category: "Frappuccino",
        temperature: "Blended",
        difficulty: "Medium",
        important_notes: "Available in coffee and crème options",
        full_recipe: "Pump Frappuccino Roast 2/3/4 (Skip this step for Blended Crème). Pour whole milk to lower line on cup. Pour cup contents into blender pitcher. Pump Pistachio Sauce 1/2/3. Add ice - Use appropriate size scoop. Pump Coffee or Crème Frappuccino syrup base 2/3/4. Blend - Press button #1. Top with whipped cream and Salted Brown Butter topping.",
        seasonal: true,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Unique nutty flavor profile"
    },
    {
        id: 98,
        drink_name: "Lavender Crème Frappuccino",
        size: "All Sizes",
        abbreviation: "LCF",
        shots: "",
        syrup_pumps: "1/2/3",
        ...
        milk_line: "lower line",
        aeration_time: "",
        special_ingredients: "2/2/3 level scoops lavender powder",
        toppings: "whipped cream",
        preparation_method: "blend",
        category: "Frappuccino",
        temperature: "Blended",
        difficulty: "Medium",
        important_notes: "Pour blended beverage contents into cup 1/4 inch (6mm) below cup rim",
        full_recipe: "Pour whole milk to lower line on cup. Pour cup contents into blender pitcher. Pump Vanilla syrup (full dose pump) 1/2/3. Scoop Lavender powder (level scoops) 2/2/3. Add ice - Use appropriate size scoop. Pump Frappuccino Crème syrup base 2/3/4. Blend - Press button #1. Pour blended beverage contents into cup 1/4 inch (6mm) below cup rim. Top with whipped cream.",
        seasonal: true,
        popular: false,
        prep_time: "2-3 minutes",
        tips: "Sweet and subtle floral notes"
    },
    // US ONLY ENERGY DRINKS:
    {
        id: 99,
        drink_name: "Melon Burst Iced Energy",
        size: "Venti",
        abbreviation: "MBIE",
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "",
        aeration_time: "",
        special_ingredients: "chilled Melon Cucumber Energy can, Passion Tango Tea",
        toppings: "ice",
        preparation_method: "build", 
        category: "Energy",
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "VENTI ONLY, US ONLY",
        full_recipe: "Add a Grande scoop of ice directly into the Venti cup. Tilt the cup and pour entire contents of chilled Melon Cucumber Energy can into cup. Pour Passion Tango Tea slowly on top to 1/4 inch below cup rim. Lid: Strawless Lid.",
        seasonal: false,
        popular: false,
        prep_time: "1 minute",
        tips: "Sugar-free energy boost with hibiscus and melon flavors"
    },
    {
        id: 100,
        drink_name: "Tropical Citrus Iced Energy", 
        size: "Venti",
        abbreviation: "TCIE",
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "",
        aeration_time: "",
        special_ingredients: "chilled Tropical Citrus Energy can, Green Tea",
        toppings: "ice",
        preparation_method: "build",
        category: "Energy", 
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "VENTI ONLY, US ONLY",
        full_recipe: "Add a Grande scoop of ice directly into the Venti cup. Tilt the cup and pour entire contents of chilled Tropical Citrus Energy can into cup. Pour Green Tea slowly on top to 1/4 inch below cup rim. Lid: Strawless Lid.",
        seasonal: false,
        popular: false,
        prep_time: "1 minute", 
        tips: "Passionfruit and citrus with mint-tinted green tea"
    },
    {
        id: 101,
        drink_name: "Frozen Tropical Citrus Iced Energy",
        size: "Venti",
        abbreviation: "FTCIE", 
        shots: "",
        syrup_pumps: "4",
        syrup_type: "crème frappuccino base",
        milk_type: "",
        milk_line: "middle line",
        aeration_time: "",
        special_ingredients: "chilled Tropical Citrus Energy, strawberry puree",
        toppings: "",
        preparation_method: "blend",
        category: "Energy",
        temperature: "Blended",
        difficulty: "Medium", 
        important_notes: "VENTI ONLY, US ONLY. Discard leftover energy drink after handling",
        full_recipe: "Pour chilled Tropical Citrus Energy to middle line of cup (there will be some left over - discard after handling beverage). Pour cup contents into blender pitcher. Add a Grande scoop of ice directly into blender pitcher. Pump Crème Frappuccino syrup base 4. Blend - Press button #1. Add Strawberry puree to lowest ridge (or top dot if applicable) on bottom of cup. Pour blender contents into cup. Lid: Strawless Lid.",
        seasonal: false,
        popular: false,
        prep_time: "2-3 minutes",
        tips: "Frozen energy drink with strawberry swirls"
    },

    // CORRECTED EXISTING RECIPES:

    // Your Iced Chai needs to be separate from hot chai:
    {
        id: 102,
        drink_name: "Iced Chai Latte",
        size: "All Sizes",
        abbreviation: "CH", 
        shots: "",
        syrup_pumps: "3/4/6",
        ...
        difficulty: "Easy", 
        important_notes: "Water is not added to Iced Chai lattes",
        full_recipe: "Pump Chai concentrate 3/4/6 (T/G/V). Add cold milk to upper line on cup. Fill cup with ice to 1/4 inch (6 mm) below cup rim. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "1-2 minutes",
        tips: "No water added unlike hot version"
    },
    {
        id: 103,
        drink_name: "Steamed Milk",
        size: "All Sizes",
        abbreviation: "SM",
        shots: "",
        syrup_pumps: "",
        syrup_type: "",
        milk_type: "steamed milk",
        milk_line: "appropriate line",
        aeration_time: "1-3 seconds",
        special_ingredients: "",
        toppings: "1/4 inch foam",
        preparation_method: "steam",
        category: "Other",
        temperature: "Hot",
        difficulty: "Easy",
        important_notes: "Steam to KIDS setting for a child. Short is the size for Kid's SM.",
        full_recipe: "Pour milk to appropriate line on pitcher. Aerate 1-3 seconds. Fill with steamed milk and 1/4 inch foam to 1/4 inch (6 mm) below cup rim.",
        seasonal: false,
        popular: false,
        prep_time: "1-2 minutes",
        tips: "Simple steamed milk with minimal foam"
    },
    {
        id: 104,
        ...
        shots: "",
        syrup_pumps: "3/4/6",
        syrup_type: "mocha sauce",
        milk_type: "cold milk",
        milk_line: "1/4 inch below rim",
        aeration_time: "",
        special_ingredients: "",
        toppings: "",
        preparation_method: "build",
        ...
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "Tall is the size for Kid's CHM",
        full_recipe: "Pump Mocha sauce (full dose pump) 3/4/6. Fill cup with milk to 1/4 inch (6mm) below cup rim. Stir to combine. Lid: Strawless Lid.",
        seasonal: false,
        popular: false,
        prep_time: "1 minute",
        tips: "Kids menu item - cold chocolate milk"
    },
    {
        id: 105,
        drink_name: "Syrup Crème Frappuccino",
        size: "All Sizes",
        abbreviation: "SCF",
        shots: "",
        syrup_pumps: "2/3/4", // half dose pump
        syrup_type: "See Beverage ID codes (syrup)",
        milk_type: "Whole",
        milk_line: "lower line",
        aeration_time: "",
        special_ingredients: "",
        ...
        temperature: "Blended",
        difficulty: "Easy",
        important_notes: "*for full dose pump use 1/2/2 pumps for T/G/V",
        full_recipe: "Pour whole milk to lower line on cup. Pour cup contents into blender pitcher. Pump syrup (half dose pump) 2/3/4. Add ice - Use appropriate size scoop. Pump Crème Frappuccino syrup base 2/3/4. Blend - Press button #1. Pour blender contents into cup. Top with whipped cream. Lid (with whipped cream): Dome Lid. Lid (without whipped cream): Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Can be made with any flavored syrup"
    },

    {
        id: 106,
        drink_name: "Vanilla Bean Blended Crème",
        size: "All Sizes", 
        abbreviation: "VBF",
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "lower line",
        aeration_time: "",
        special_ingredients: "2/3/4 scoops vanilla bean powder",
        toppings: "whipped cream",
        preparation_method: "blend",
        category: "Frappuccino",
        temperature: "Blended", 
        difficulty: "Easy",
        important_notes: "Crème version - no coffee",
        full_recipe: "Pour whole milk to lower line on cup. Pour cup contents into blender pitcher. Scoop Vanilla Bean powder 2/3/4. Add ice - Use appropriate size scoop. Pump Crème Frappuccino syrup base 2/3/4. Blend - Press button #1. Top with whipped cream. Lid (with whipped cream): Dome Lid. Lid (without whipped cream): Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Real vanilla bean specks throughout"
    },

    {
        id: 107,
        drink_name: "Caffè Vanilla Frappuccino", 
        size: "All Sizes",
        abbreviation: "CVF",
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "lower line",
        aeration_time: "",
        special_ingredients: "2/3/4 pumps frap roast, 2/3/4 scoops vanilla bean powder",
        toppings: "whipped cream", 
        preparation_method: "blend",
        category: "Frappuccino",
        temperature: "Blended",
        difficulty: "Easy",
        important_notes: "Coffee version with vanilla bean",
        full_recipe: "Pump Frappuccino Roast 2/3/4. Pour whole milk to lower line on cup. Pour cup contents into blender pitcher. Scoop Vanilla Bean powder 2/3/4. Add ice - Use appropriate size scoop. Pump Coffee Frappuccino syrup base 2/3/4. Blend - Press button #1. Top with whipped cream. Lid (with whipped cream): Dome Lid. Lid (without whipped cream): Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Coffee version of Vanilla Bean Frappuccino"
    },

    {
        id: 108,
        drink_name: "White Chocolate Mocha Frappuccino",
        size: "All Sizes",
        abbreviation: "WCMF", 
        shots: "",
        syrup_pumps: "1/2/2", // full dose pump for white mocha
        syrup_type: "white chocolate mocha sauce",
        milk_type: "Whole",
        milk_line: "lower line",
        aeration_time: "",
        special_ingredients: "2/3/4 pumps frap roast",
        toppings: "whipped cream",
        preparation_method: "blend",
        category: "Frappuccino",
        temperature: "Blended",
        difficulty: "Easy",
        important_notes: "White mocha uses full dose pump unlike regular mocha",
        full_recipe: "Pump Frappuccino Roast 2/3/4. Pour whole milk to lower line on cup. Pour cup contents into blender pitcher. Pump White Chocolate Mocha sauce (full dose pump) 1/2/2. Add ice - Use appropriate size scoop. Pump Coffee Frappuccino syrup base 2/3/4. Blend - Press button #1. Top with whipped cream. Lid (with whipped cream): Dome Lid. Lid (without whipped cream): Strawless Lid.",
        seasonal: false,
        popular: true, 
        prep_time: "2-3 minutes",
        tips: "White mocha is thicker than regular mocha sauce"
    },

    // SPECIALTY NON-COFFEE BEVERAGES:

    {
        id: 109,
        drink_name: "Blended Strawberry Lemonade",
        size: "All Sizes",
        abbreviation: "BSL",
        shots: "",
        syrup_pumps: "2/3/4",
        ...
        milk_line: "",
        aeration_time: "",
        special_ingredients: "strawberry purée, lemonade",
        toppings: "",
        preparation_method: "blend",
        ...
        difficulty: "Easy",
        important_notes: "",
        full_recipe: "Pour Strawberry Purée to lower ridge on cup. Pour lemonade to lower line on cup. Pour cup contents into blender pitcher. Add ice - Use appropriate size scoop. Pump Crème Frappuccino syrup base 2/3/4. Blend - Press button #1. Pour blender contents into cup. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Refreshing summer drink"
    },

    {
        ...
        difficulty: "Easy",
        important_notes: "",
        full_recipe: "Pour lemonade to top line in cup. Fill cup with ice to 1/4 inch (6 mm) below cup rim. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "30 seconds",
        tips: "Simple and refreshing"
    },
    {
        id: 111, // ADD MISSING GRANDE HOT CHOCOLATE
        drink_name: "Grande Hot Chocolate", 
        size: "Grande",
        abbreviation: "HC",
        shots: "",
        syrup_pumps: "4 mocha + 1 vanilla",
        syrup_type: "mocha sauce + vanilla",
        milk_type: "2%",
        milk_line: "third line",
        aeration_time: "1-3 seconds",
        special_ingredients: "",
        ...
        temperature: "Hot",
        difficulty: "Easy",
        important_notes: "Don't forget the vanilla pump",
        full_recipe: "Pour 2% to third line on pitcher, aerate 1-3 seconds, 4 pumps of mocha and ONE pump of vanilla into cup, pour milk and top with whip and mocha drizzle.",
        seasonal: false,
        popular: true,
        prep_time: "2-3 minutes",
        tips: "Most popular hot chocolate size"
    },
    {
        id: 112,
        drink_name: "Mango Dragonfruit Refresher", 
        size: "All Sizes",
        abbreviation: "MDR",
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "",
        aeration_time: "",
        special_ingredients: "mango dragonfruit base, water, dragonfruit inclusions",
        toppings: "ice",
        preparation_method: "shake",
        category: "Refresher",
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "Must be shaken 10 times",
        full_recipe: "Add Mango Dragonfruit base - Fill shaker to Base line. Add cold water - Fill shaker to Water/Lemonade/Milk line. Scoop dragonfruit inclusion 1/1/1/2 (T/G/V/TR). Fill with ice to Ice line. Put lid on shaker and shake vigorously 10 times. Pour contents into cup. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "1-2 minutes",
        tips: "Include dragonfruit pieces when pouring"
    },

    {
        id: 113,
        drink_name: "Mango Dragonfruit Lemonade",
        size: "All Sizes",
        abbreviation: "MDRL", 
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "",
        aeration_time: "",
        special_ingredients: "mango dragonfruit base, lemonade, dragonfruit inclusions",
        toppings: "ice",
        preparation_method: "shake",
        category: "Refresher",
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "Use lemonade instead of water",
        full_recipe: "Add Mango Dragonfruit base - Fill shaker to Base line. Add lemonade - Fill shaker to Water/Lemonade/Milk line. Scoop dragonfruit inclusion 1/1/1/2 (T/G/V/TR). Fill with ice to Ice line. Put lid on shaker and shake vigorously 10 times. Pour contents into cup. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "1-2 minutes", 
        tips: "Lemonade adds tartness to balance the tropical flavors"
    },

    {
        id: 114,
        drink_name: "Dragon Drink",
        size: "All Sizes",
        abbreviation: "DRG",
        shots: "",
        syrup_pumps: "",
        syrup_type: "",
        milk_type: "coconutmilk",
        milk_line: "",
        aeration_time: "",
        special_ingredients: "mango dragonfruit base, coconutmilk, dragonfruit inclusions", 
        toppings: "ice",
        preparation_method: "shake",
        category: "Refresher",
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "*Coconut beverage in Canada",
        full_recipe: "Add Mango Dragonfruit base - Fill shaker to Base line. Add coconutmilk - Fill shaker to Water/Lemonade/Milk line. Scoop dragonfruit inclusion 1/1/1/2 (T/G/V/TR). Fill with ice to Ice line. Put lid on shaker and shake vigorously 10 times. Pour contents into cup. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "1-2 minutes",
        tips: "Creamy coconut version of the dragonfruit refresher"
    },

    {
        id: 115,
        drink_name: "Strawberry Coconut Drink",
        size: "All Sizes",
        abbreviation: "SCD",
        shots: "",
        syrup_pumps: "",
        ...
        milk_line: "",
        aeration_time: "",
        special_ingredients: "strawberry açaí base, coconutmilk, strawberry inclusions",
        toppings: "ice",
        preparation_method: "shake",
        category: "Refresher",
        temperature: "Cold",
        difficulty: "Easy",
        important_notes: "*Coconut beverage in Canada",
        full_recipe: "Add Strawberry Açaí base - Fill shaker to Base line. Add coconutmilk - Fill shaker to Water/Lemonade/Milk line. Scoop strawberry inclusion 1/1/1/2 (T/G/V/TR). Fill with ice to Ice line. Put lid on shaker and shake vigorously 10 times. Pour contents into cup. Lid: Strawless Lid.",
        seasonal: false,
        popular: true,
        prep_time: "1-2 minutes",
        tips: "Pink drink's cousin with strawberry and coconut"
    },
];
